...
import hazardicon from '../../assets/images/hazardIcon.png';
    ...
    return (
            ...
            <div class="right-subcontainer">
                <div className="form-section">
                    ...
                    {loginError && <div className="error-message">
                        <img src={hazardicon} alt="Hazard Icon" className="hazard-icon" />
                        {loginError}
                    </div>}
                </div>
            </div>
